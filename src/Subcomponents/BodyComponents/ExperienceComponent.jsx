...
const experience = [
  {
    ...
    cDescription:
      "<b>1. Full-Stack Proficiency:</b> Mastered end-to-end development (front-end, back-end, and databases) through hands-on projects like CRUD apps and eCommerce platforms.<br></br><b>2. Industry-Ready Skills:</b> Gained practical expertise in coding standards, debugging, and testing while solving real-world problems in collaborative environments.<br></br><b>3. Project Confidence:</b> Demonstrated ability to build scalable applications from scratch—ready to leverage these skills in professional roles or advanced projects.",
  },
  {
    imgSrc: "/img/Experience/corizo.jpg",
    name: "Corizo",
    ...
    cDescription:
      "<b>1. Diverse Tech Stack Mastery:</b> Gained hands-on expertise in modern tools (MERN stack, APIs, Bootstrap) to build responsive, full-stack applications from front-end forms to back-end systems.<br></br><b>2. Practical Application Focus:</b> Developed functional projects like user management apps and e-commerce features, emphasizing clean code, debugging, and real-world problem-solving.<br></br><b>3. Industry-Aligned Readiness:</b> Strengthened technical and analytical abilities—equipped to contribute to collaborative projects or tackle complex development challenges.",
  },
  {
    ...
    cDescription:
      "<b>1. Applied Biotech Expertise:</b> Gained hands-on experience in microbial characterization and commercial biofertilizer production, bridging lab research with agricultural applications.<br></br><b>2. Sustainable Innovation:</b> Mastered advanced techniques like mushroom tissue culture and Black Soldier Fly larvae rearing, contributing to eco-friendly feed and farming solutions.<br></br><b>3. Entrepreneurial Readiness:</b> Developed technical and problem-solving skills in environmental biotechnology, poised to drive sustainable agri-tech ventures or research.",
  },
  {
    ...
    cDescription:
      "<b>1. Sustainable Food Tech Proficiency:</b> Operated advanced millet processing machinery while contributing to eco-friendly packaging solutions, merging technology with sustainability.<br></br><b>2. Industry-Ready Skills:</b> Gained hands-on experience in sustainable agriculture under expert guidance, translating theoretical knowledge into practical, scalable solutions.<br></br><b>3. Future-Focused Impact:</b> Developed a nuanced understanding of eco-conscious food production equipped to drive innovation in agri-tech or sustainable food systems.",
  },
];
