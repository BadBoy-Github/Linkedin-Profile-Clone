  ...
  return (
    <>
      <div className="w-full h-[36vh] mx-2 group relative">
        <div className="h-full min-w-96 max-w-60 border border-[#38434f] rounded-xl overflow-hidden flex flex-col">
          ...
          <div className="relative bg-[#1b1f23] border-t border-[#38434f] h-[70px] overflow-hidden transition-all duration-300 group-hover:h-[200px]">
            {/* Moving text */}
